...
print("If using Windows, please make sure there are no spaces in filename.")
file_name = input("Enter filename (including .csv): ")
print("Excel file will be saved in the same folder with original .csv as '" + file_name[:-4] + "_analyzed.xlsx'")
